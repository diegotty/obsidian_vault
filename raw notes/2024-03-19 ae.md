...
## jal
salta a un indirizzo, ma salva in `$ra` l’address della prossima istruzione del chiamante. quindi a fine funzione, basta saltare all’indirizzo in `$ra` per tornare al punto giusto del chiamante
