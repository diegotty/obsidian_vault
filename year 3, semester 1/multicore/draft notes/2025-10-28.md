...
## gustafson’s law
if we consider weak scaling, the parallel fraction increases with the problem size ! so the serial time remains constat, but the parallel time increases. this is also known as *scaled speedup*:
$$
