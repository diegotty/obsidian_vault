...
- *reduce*: collect the partial results and derive the complete one ([[02 - MPI, introduction and message sending#`MPI_Reduce`]])
...
this is implemented with functions like [[02 - MPI, introduction and message sending#`MPI_Reduce`|MPI_Reduce]] !
